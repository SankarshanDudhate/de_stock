...
class _PostAdState extends State<PostAd> {
  ...
  String pickupLocationAddress; //Required
  String newSpec;
                      ...
                      GestureDetector(
                        onTap: () async {
                          if (!_formKeyPostAd.currentState.validate()) {
                            Get.snackbar("Validation error", "Please enter valid data");
                            return;
                          }

                          if(pickupLocation == null) {
                            Get.snackbar("Validation error", "Please pick a valid location");
                            return;
                          }

                          _formKeyPostAd.currentState.save();
                          // log(_specs.toString());
                          // log(pickupLocation.toString());

                          Map locationMap = {"lat": pickupLocation.latitude, "long": pickupLocation.longitude};

                          //Save all data here!!!!!
                          //_specs is a list of maps containg spec name and details
                          var adData = {
                            "unit": selectedUnit,
                            "name": productName,
