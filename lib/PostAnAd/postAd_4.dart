                      ...
                      child: Column(children: <Widget>[
                        ...
                        GestureDetector(
                          onTap: () async {
                            ...
                            // for (var image
                            //     in jsonDecode(adDataJson["images"])) {
                            ...
                            // String url =
                            //     "http://192.168.43.167:5000/products/add/";
                          ...
                          child: Container(
                            ...
                            child: Center(
                              child: Text("Save and add a new product",
                                  style: TextStyle(
                                      color: Colors.white,
                                      fontSize: 18,
                                      fontWeight: FontWeight.bold)),
                        ...
                        GestureDetector(
                          onTap: () async {
                            ...
                            adData["price"] = productPrice;
                            adData["disclose_price"] = disclosePrice;
                            log(adData.toString());
                            // prefs.setString("postAnAdData", jsonEncode(adData));
                            prefs.remove("postAnAdData");

                            List<String> adsList = [];
                            if(prefs.containsKey("adsList"))
                              List<String> adsList = prefs.getStringList("adsList");

                            adsList.add(jsonEncode(adData));
                            prefs.setStringList("adsList", adsList);
