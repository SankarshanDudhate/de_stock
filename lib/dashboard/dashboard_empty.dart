          ...
          child: Column(
            children: <Widget>[
              ...
              Text(
                ...
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold, color: Color(0xffD84764)),
              ),
              SizedBox(
                height: 20,
              ),
...
class options_large extends StatelessWidget {
  final String title;
  final String image;
  const options_large({Key key, this.title, this.image}) : super(key: key);
...
class Title_with_no extends StatelessWidget {
  final String title;
  final String number;
  const Title_with_no({Key key, this.title, this.number}) : super(key: key);
