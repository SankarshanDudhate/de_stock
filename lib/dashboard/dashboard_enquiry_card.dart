                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        "Qty " + data["quantity"], //TODO bold the amount and unit (data[quantity]) using rich text
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              width: 220,
                              child: Text(
                                '#'+widget.product_id+'23ABC456', //TODO replace with actual random id
                                textAlign: TextAlign.left,
                                style: TextStyle(
                                    fontSize: 12,
                                    fontWeight: FontWeight.w400,
            ...
            Container(
              ...
              child: GestureDetector(
                onTap: () async {
                  ...
                  String url =
                      '$localhostAddress/products/enquiries/reply/';
                  var dataObj = {
