...
class request_quote_notification extends StatefulWidget {
  ...
  request_quote_notification({Key key, this.buyer_name,this.product_name,this.product_image,this.buyer_image,this.time,this.is_read});
//      : super(key: key);

  @override
  _request_quote_notificationState createState() => _request_quote_notificationState();
}

class _request_quote_notificationState extends State<request_quote_notification> {
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Image.asset(widget.buyer_image,height: 50,),
                        Container(
                          width: 180,
                          child: RichText(
                            text: TextSpan(
            ...
            children: [
              ...
              GestureDetector(
                ...
                child: Container(
                    ...
                    decoration: BoxDecoration(color: Color(0xffFC0151),
