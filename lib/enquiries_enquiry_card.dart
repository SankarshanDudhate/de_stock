...
class enquiry_card extends StatefulWidget {
  ...
  enquiry_card({Key key, this.product_id,this.product_name,this.product_price, this.image, this.enquiry_data})
      : super(key: key);
...
class _enquiry_cardState extends State<enquiry_card> {
  ...
  Widget replyText(BuildContext context, data) {
    ...
    if (!data["replied"]){
      return GestureDetector(
        onTap: () {
          _buildReply(context, data["buyer_name"],data["enquiry"], data["buyer_image"], widget.product_id, widget.product_name,widget.image, data["quantity"], indexInList);
        },
        child: Text("REPLY",
  ...
  Widget enquiriesBuilder(BuildContext context) {
    return Column(
      children: widget.enquiry_data.map((enquiry) => enquiries(context, enquiry)).toList(),
    );
  }
      ...
      child: Row(
        ...
        children: [
          ClipRRect(
              ...
              child: Image.memory(base64Decode(data["buyer_image"]), height: 50,)),
          Padding(
      ...
      child: Column(
        children: [
          Container(
            ...
            child: Row(
              children: [
                Image.memory(base64Decode(widget.image), height: 60,),
                Padding(
  ...
  void _buildReply(BuildContext context, String user_name,String user_enquiry,String user_image,String product_id,String product_name,String product_image,String quantity, int productIndex) {
            ...
            Row(
              children: [
                ClipRRect(
                    ...
                    child: Image.memory(base64Decode(user_image), height: 50,)),
                SizedBox(width:20),
              ...
              child: Row(
                  children: [
                    ...
                    ClipRRect(
                        ...
                        child: Image.memory(base64Decode(product_image), height: 50,)),
                  ]
              ),
            ),
            SizedBox(height: 20,),
