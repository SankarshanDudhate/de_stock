...
class reply_quote_notification extends StatefulWidget {
  ...
  reply_quote_notification({Key key, this.seller_name,this.product_name,this.product_image,this.seller_image,this.time,this.is_read});
//      : super(key: key);

  @override
  _reply_quote_notificationState createState() => _reply_quote_notificationState();
}
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Image.asset(widget.seller_image,height: 50,),
                        Container(
                          width: 180,
                          child: RichText(
                            text: TextSpan(
                                ...
                                children: [
                                  ...
                                  TextSpan(
                                    text: ' has replied to your quote for the following product',
                                    style: TextStyle(
                                      fontFamily: 'Poppins',
                                      fontSize: 12,
